...
const AddProperty = () => {
  ...
  const handleMediaChange = (e) => {
    ...
    // Generate preview URLs (only for images, videos can show file name)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Redirect with a success state (optional)
    ...
    <div className="page-card">
      ...
      <form onSubmit={handleSubmit} className="dashboard-form-stack">
        ...
        >
          {uploading ? (
            <>
              <span className="animate-pulse" style={{ display: "inline-block", width: "1rem", height: "1rem", background: "currentColor", borderRadius: "50%", marginRight: "0.5rem" }}></span>
              Uploading…
            </>
          ) : (
